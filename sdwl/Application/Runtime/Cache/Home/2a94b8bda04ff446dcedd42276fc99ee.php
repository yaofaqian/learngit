...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(".down").mousemove(function(){
            ...
            $(".icon").css("background","url(/Public/asset/home/image/icon.png) 0 -110px no-repeat");
            $(".download-iphone-text").css("color","white");
        }).mouseout(function(){
            $(".downlod-iphone").css("background-color", "white");
            $(".icon").css("background","url(/Public/asset/home/image/icon.png) 0 0 no-repeat");
            $(".download-iphone-text").css("color","#8c8a8c");
        });

        $(".dowm").mousemove(function(){
            $(".downlod-androud").css("background-color", "#1879ef");
            $(".icom").css("background","url(/Public/asset/home/image/icon.png) -77px -111px no-repeat");
            $(".download-androud-text").css("color","white");
        }).mouseout(function(){
            $(".downlod-androud").css("background-color", "white");
            $(".icom").css("background","url(/Public/asset/home/image/icon.png) -77px 0 no-repeat");
